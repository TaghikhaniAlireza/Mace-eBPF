...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn mace_register_event_callback(cb: JsonCallback) {
...
#[unsafe(no_mangle)]
pub extern "C" fn mace_unregister_event_callback() {
    if let Ok(mut w) = GLOBAL_JSON_CALLBACK.write() {
        *w = None;
    }
}
...
mod tests {
    ...
    fn register_invokes_json() {
        ...
        *LAST.lock().unwrap() = None;
        ...
        unsafe {
            mace_register_event_callback(test_cb);
        }
        ...
        mace_unregister_event_callback();
